...
<div class="add-course-page">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Create a new course for the system</p>
        </div>
    ...
    <div class="form-container">
        <form method="POST" action="<?= base_url('admin/courses/create') ?>" class="course-form">
            <?= csrf_field() ?>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text">Assign a teacher to this course (can be assigned later)</small>
                </div>
