...
<div class="edit-user-page">
    ...
    <div class="form-container">
        <form method="post" action="<?= base_url('admin/users/edit/' . $user['id']) ?>" class="user-form">
            ...
            <div class="form-group">
                ...
                <input type="password" 
                       ...
                       name="password" 
                       class="form-control">
                <small class="form-text">Leave blank to keep current password. Minimum 8 characters with letters and numbers.</small>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="role" name="role" class="form-control" required>
                    ...
                    <option value="teacher" <?= set_value('role', $user['role']) == 'teacher' ? 'selected' : '' ?>>Teacher</option>
                    <option value="student" <?= set_value('role', $user['role']) == 'student' ? 'selected' : '' ?>>Student</option>
                </select>
